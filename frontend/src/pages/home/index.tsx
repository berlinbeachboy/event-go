                ...
                <div className="mb-16">
                    ...
                    <div className="prose prose-gray max-w-none">
                        <ul className="space-y-2 text-gray-700">
                            <li>Es gibt dieses Jahr aus finanziellen und organisatorischen Gründen <b>keine Tagestickets</b>.</li>
                            ...
                            <li>Das Schichtsystem wird etwas angepasst: Alle müssen nun <b>am Montag zwischen 10 und 12 eine Aufräumschicht</b> machen.</li>
                        </ul>
                    </div>
                </div>
            </motion.div>
